...
//
// Information: Implementation of the D-GMM algorithm
// training model 3
...
template <typename T>
class D_gmm : public Gmm_core<T> {

public:

    // ----- CONSTRUCTORS AND DESTRUCTORS -----
    D_gmm(const dataset<T>& _set, blaze::DynamicMatrix<T, blaze::rowMajor>& _mean, int _H, int nthreads, T var, int _R, int _verbose) :
